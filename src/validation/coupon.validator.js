...
const createCoupon = Joi.object({
  ...
  applicableTo: Joi.string()
    .valid("all", "Test", "TestSeries", "Course", "Olympiad", "Tournament", "Workshop", "Ecommerce", "LiveCompetition")
    .default("all"),
});
...
const applyCoupon = Joi.object({
  ...
  itemType: Joi.string()
    .valid("test", "testBundle", "course", "olympiad", "tournament", "workshop", "ecommerce", "all", "LiveCompetition", "liveCompetition", "live_competition")
    .default("all"),
});
